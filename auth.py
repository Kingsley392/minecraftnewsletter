...
def signup(email, password, username, serverIP, serverCode, minecraftVersion, memberInfo):
    try:
...
def show_login_signup_form():
    ...
    if choice == "Login":
        ...
        if st.sidebar.button("Create Account", key="signup_btn"):
            signup(email, password, username, serverIP,
                   serverCode, minecraftVersion, memberInfo)
